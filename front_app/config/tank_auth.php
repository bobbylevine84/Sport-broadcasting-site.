...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Wordrates & Pitchlab';
$config['webmaster_email'] = 'ejuicy.team@gmail.com';
...
|--------------------------------------------------------------------------
*/
$config['forgot_password_expire'] = 60*60*60*60*15;
...
$config['captcha_expire'] = 180*180*180;
...
$config['recaptcha_public_key'] = '6Lf18wUTAAAAAJn-RBMDt_MYquzAa8wl2IpESBFs';
$config['recaptcha_private_key'] = '6Lf18wUTAAAAAPurcoRMYqsOnolFVDAwXBTPfH4o';
