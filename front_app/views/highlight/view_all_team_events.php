...
<?php $new_session_time= $this->session->userdata('time_formate') * 60 * 60; $current_date = gmdate('Y-m-d H:i:s');	?><?php $rss = $this->load->database('rss', TRUE);
//echo "<pre>"; print_r($get_team_events);exit;?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="table-responsive">
				...
				<td class="brdr-right">
					<div class="event-data eventdata-main" style="text-align:center">
						<span class="cont-flag">
							...
							if (file_exists($_SERVER["DOCUMENT_ROOT"].'/wiziwig/Flags/'.ucwords($nation).'.png')) {
							?>
	...
	</table><input type="hidden" id="team_id_for_calender" class="team_id_for_calender" value="<?php echo $team_id_for_calender;?>" >
</div>
</div>
</div>
</div>
