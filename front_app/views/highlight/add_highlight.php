...
<html lang="en">
    <head>
        ...
        <title>RealsportStreams - Add Highlight</title><!--
					...
					<div class="panel-body alerts-panel">
						...
						<div class="wrapper" id="input_embed">
							<div class="form-group">
								...
								<textarea rows="5" cols="90" name="embed_code" placeholder="Embed Code....."></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="standard-list1">Video Type</label>
							<select class="form-control" id="type" name="type">
								<option value="Highlights" selected >Match Highlights</option>
								<option value="Goals">Match Goals</option>
								<option value="Full Match Record">Full Match Video</option>
