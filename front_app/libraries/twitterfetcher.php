...
//                $configObj['url'] = "https://api.twitter.com/1.1/statuses/user_timeline.json"; // Old
		$configObj['url'] = "http://api.twitter.com/1.1/statuses/home_timeline.json";
//echo $configObj['url'];exit;
...
//                    echo "<pre>"; print_r($configObj);exit;
//			show_error('ERROR: There was a problem accessing your tweets');
                    echo "There was a problem accessing your tweets";
		}
		else {
