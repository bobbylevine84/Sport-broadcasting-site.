...
(function() { //<span class='street'>\n    <input type='text' />\n    <div class='input-line'>\n  <span class='city'>\n    <input type='text' />\n    <label>City</label>\n  </span>\n\n  <span class='state'>\n    <input type='text' />\n    <label>State / Province / Region</label>\n  </span>\n</div>
  Formbuilder.registerField('country', { //<div class='input-line'>\n  <label>Address</label>\n  </span>\n</div>\n // <span class='zip'>\n    <input type='text' />\n    <label>Zipcode</label>\n  </span>\n
    order: 50,
    view: "<div class='input-line'>\n \n  <span class='country'>\n    <select><option>United States</option></select>\n </span>\n</div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-home\"></span></span> Country"
  });
...
this["Formbuilder"]["templates"]["partials/email_check"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-save-wrapper\'>\n  <input name=\'email'+'\' class=\'js-save-form ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'\'/>\n</div>';
