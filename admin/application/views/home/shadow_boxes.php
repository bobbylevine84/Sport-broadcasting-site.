            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        	...
                        	<ul class="nav panel-tabs">
                                ...
                                <li class="">
								 ...
								 <li class="">
                                	...
                                	<a href="#shadow_box_4" data-toggle="tab">Right sidebar</a>
						...
						$box4_id = $boxes_data[4]['id'];

						$box4_title = $boxes_data[4]['title'];
                   ...
                   <?php echo $box3_title;?>
								...
								<div id="shadow_box_4" class="tab-pane">

									<form action="<?php echo base_url('home/manage_shadow_boxes/update_right_sidebar'); ?>" method="post" >
                                    	...
                                    	<table border="0" class="table table-striped">
											...
											<tr>
												...
												<td>
 <textarea class="ckeditor form-control editor1" rows="14"  name="right_sidebar_title">
 <?php echo $boxes_data[4]['desc']; ?>
 </textarea>
												<!--	<input type="text" class="form-control" value="<?php echo $boxes_data[4]['desc']; ?>" name="right_sidebar_title" />-->
                                            ...
                                            <tr>
                                                ...
                                                <td><label>Right sidebar:</label></td>

                                                <td>

                                                    <textarea class="ckeditor form-control editor1" rows="14"  name="right_sidebar_contents">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <div class="col-md-offset-4 col-md-4">
                                                        ...
                                                        <input name="right_sidebar_id" type="hidden" value="<?php echo $box4_id;?>" />
