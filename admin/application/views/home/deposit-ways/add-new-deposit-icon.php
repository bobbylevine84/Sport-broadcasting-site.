        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="alert-danger"><?php echo validation_errors(); ?></div>
              ...
              <form class="cmxform" id="add_new_slider_image_frm" method="POST" action="<?php echo SURL?>home/manage-section/add-icon-deposit-process" enctype="multipart/form-data">
                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      <div class="form-group">
                        <label for="page_title">Upload Deposit Icon *</label>
                        	<br/>
                      ...
                      <span class="help-block margin-top-sm"><i class="fa fa-bell"></i> 
                        ...
                        <input type="text" name="deposit_link" id="display_order" class="form-control">
                      </div>
                      </div>
