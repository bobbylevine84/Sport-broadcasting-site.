      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <form class="cmxform" id="" action="<?php echo base_url(); ?>custom/manage_custom/custom_sport_process" method="POST"  enctype="multipart/form-data">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="panel-body alerts-panel">
						...
						<?php 
							...
							$get_sport = $this->db->get('kt_sport_custom_text')->result_array();
						...
						<div class="wrapper" id="description">
							<div class="form-group">
								...
								<div class="spin">
								<textarea class="ckeditor editor1" name="detail" id="spinnable_detail" name="detail" rows="14"><?php echo $get_sport[0]['article']; ?></textarea>
								</div>
								<textarea rows="5" id="fixed" style="width:100%;border-radius:3%;" name="article" placeholder="Add Description....."><?php echo $get_sport[0]['article']; ?></textarea>
							</div>
						</div>
						<?php $this->db->select('id');
						$this->db->where('sport_id',$sport['id']);
						$get_id = $this->db->get('kt_sport_custom_text')->result_array();
						?>
