      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <form class="cmxform" id="" action="<?php echo base_url(); ?>custom/manage_custom/custom_home_process" method="POST"  enctype="multipart/form-data">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="panel-body alerts-panel">
						...
						<?php 
							...
							$get_events = $this->db->get('kt_home_custom_text')->result_array();
