                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control editor1" rows="14"  id="slider_caption" name="description" ><?php echo $session_post_data['slider_content'] ?></textarea>
                      </div>
					 <div class="form-group" style="padding-left: 0px;">
                                    <label for="brand"><b>Brand</b></label>
                                    <input id="brand" name="brand" type="text" class="form-control" style="width:50%;"/>
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" id="product_type" name="product_type" class="form-control" style="width:50%;">
					 ...
					 <div class="form-group col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <ul id="selected_flavors" class="list-inline">
                                    <?php if(!empty($exist_tg)) { foreach($exist_tg as $tag) { ?>
