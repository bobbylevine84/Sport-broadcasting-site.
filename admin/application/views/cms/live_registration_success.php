                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                            	<span class="glyphicon glyphicon-book"></span>Manage Live Registration Success Download Page Contents
                            </div>                            
                        </div>                        
                        <div class="panel-body">
							<div id="shadow_box_1" class="tab-pane active">
								<form action="<?php echo base_url('cms/manage-pages/live_registration_success_update'); ?>" method="post" >
