        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_new_cms_page_frm" method="POST" action="<?php 
			  echo SURL?>menu/manage-menu/edit-content-process">
                <div class="tab-content border-none padding-none">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-11">
                        	<label for="standard-list1">
						  		<? echo strtoupper(url_title(stripslashes($page_data['slug_menu']),'_', FALSE));
								 ?> 
                       		</label>
                        </div>
                    </div>
                      ...
                      <div class="form-group">
                        <label for="page_long_desc">Page Title</label>
                        <input type="text" class="form-control" name="page_title" value="<? echo stripslashes($page_data['page_title']);
								 ?>"/>
                      </div>
                      
                      <div class="form-group">
                        <label for="page_long_desc">Page Content</label>
                      </div>
                      <div class="form-group">
                        <textarea class="ckeditor editor1"  id="page_long_desc" name="page_long_desc" rows="14"><?php echo stripslashes($page_data['page_long_desc']) ?></textarea>
                      </div>
                    <div class="row form-group">
                  ...
                  <div id="seo_contents" class="tab-pane">
                    <div class="form-group">
                      ...
                      <input id="meta_title" name="meta_title" type="text" class="form-control" value="<?php echo stripslashes($page_data['meta_title']) ?>" placeholder="Meta Title"/>
                    </div>
                    <div class="form-group">
                      <label for="meta_keywords">Meta Keywords</label>
                      <textarea class="form-control" id="meta_keywords" name="meta_keywords" rows="3"><?php echo stripslashes($page_data['meta_keywords']) ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="meta_description">Meta Description</label>
                      <textarea class="form-control" id="meta_description" name="meta_description" rows="3"><?php echo stripslashes($page_data['meta_description']) ?></textarea>
                    </div>
                    <div class="form-group">
