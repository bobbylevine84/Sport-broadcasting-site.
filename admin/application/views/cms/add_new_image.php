        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Add New Partners Image </div>
              
            </div>
            
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="add_new_liquidity_image_frm" method="POST" action="<?php echo SURL ?>cms/manage-partners/add-new-image-process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      <div class="form-group">
                        <label for="page_title">Upload liquidity Image *</label>
						 <input type="file" id="liquidity_image" name="partners_image">
                            <span class="help-block margin-top-sm"><i class="fa fa-bell"></i> 
                                - Allowed Extensions: jpg, jpeg, gif, tiff, png
                            </span>
                            <span class="help-block margin-top-sm"><i class="fa fa-bell"></i> 
                                Max Upload Size: 1MB; Recommended Dimension: 350 * 200                            </span>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="add_image_sbt" id="add_image_sbt" value="Add New Partners" />
                    </div>
                </div>
