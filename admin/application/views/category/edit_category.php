        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Edit Category </div>
            ...
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="upd_new_category_frm" method="POST" action="<?php echo SURL?>category/manage-category/edit-category-process">
                <div class="tab-content border-none padding-none">
                  ...
                  <div class="row form-group">
                      ...
                      <div class="col-xs-3">
                        <input type="text" name="display_order" id="display_order" value="<?php echo $category_arr['display_order']?>" class="form-control">
                      </div>
                    </div>
                    <div class="row form-group">
                  ...
                  <div id="seo_content" class="tab-pane">
                    <div class="form-group">
                      ...
                      <input id="meta_title" name="meta_title" type="text" class="form-control" value="<?php echo stripslashes($category_arr['meta_title']) ?>" placeholder="Meta Title"/>
                    </div>
                    
                    <div class="form-group">
                      <label for="meta_keywords">Meta Keywords</label>
                      <textarea class="form-control" id="meta_keywords" name="meta_keywords" rows="3"><?php echo stripslashes($category_arr['meta_keywords']) ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="meta_description">Meta Description</label>
                      <textarea class="form-control" id="meta_description" name="meta_description" rows="3"><?php echo stripslashes($category_arr['meta_description']) ?></textarea>
                    </div>
                    <div class="form-group">
                    <label for="category_description">Category Description</label>
                    </div>
                    <div class="form-group">
                    <textarea class="ckeditor editor1"  id="category_description" name="category_description" rows="14"><?php echo stripslashes($category_arr['category_description']) ?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="seo_url_name">SEO URL Name</label>
                      <input id="seo_url_name" name="seo_url_name" type="text" value="<?php echo stripslashes($category_arr['seo_url_name']) ?>" class="form-control" readonly />
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="upd_new_cat_sbt" id="upd_new_cat_sbt" value="Update Category" />
                        <input type="hidden" name="cat_id" id="cat_id" value="<?php echo stripslashes($category_arr['id'])?>" readonly>
                    </div>
                </div>
