                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body alerts-panel">
                            <form class="cmxform" id="add_new_menu_frm" method="POST" 
                            	action="<?php echo SURL?>menu/manage-buttons/add-new-button">
								<div class="row">
									<div class="col-md-offset-3 col-md-6">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="">
													<input type="radio" name="button_type" checked="checked" value="1"> Blue
													<input type="radio" name="button_type" value="2"> Black
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Label / Title / Name:</label>
													<input type="text" name="button_slug" class="form-control">
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group clearfix">
											<button type="submit" class="btn btn-primary pull-right">Create Button</button>
										</div>
									</div>
								</div>
                            </form>
