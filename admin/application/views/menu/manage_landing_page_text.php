  ...
  <!-- Start: Content -->
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                        	...
                        	<ul class="nav panel-tabs">
                        		<li class="active">
                                	<a href="#welcome_content" data-toggle="tab">Welcome Homepage Personal Section</a>
                              	</li>
								<li class="">
                                	<a href="#welcome_content_1" data-toggle="tab">Welcome Homepage Business Section</a>
                              	</li>
                        		<!--<li class="">
                        ...
                        <div class="panel-body alerts-panel">
                            ...
                            <div class="tab-content border-none padding-none">
                                <div id="welcome_content" class="tab-pane active">
                                	<?php 
									//echo '<pre>';
									//print_r($adminsetting[0]['content']);exit;
		$sec_content = $adminsetting[0]['content'];	

		$id = $adminsetting[0]['id'];
		
		
	?>
    <form action="<?php echo base_url('menu/manage_buttons/update_sections'); ?>" method="post" enctype="multipart/form-data">
    <table border="0" class="table table-striped">
       ...
       <!-- <tr>
            ...
            <td>
            	<div class="col-md-6">
                <select id="menu_url1" class="form-control" onChange="show_hide1();" >
                ...
                <div class="col-md-6">
					...
					<select style="display:block" name="menu_url_self" id="menus" class="form-control">
...
<input type="hidden" value="<?php echo $iframe;?>" name="curr_iframe" />
	...
	<div id="welcome_content_1" class="tab-pane">
    
           <?php 
		 $this->load->view('menu/sections_3');
	?>
    <!--<form action="<?php echo base_url('home/manage_section/update_sections'); ?>" method="post" enctype="multipart/form-data">
    <table border="0" class="table table-striped">
        <tr>
