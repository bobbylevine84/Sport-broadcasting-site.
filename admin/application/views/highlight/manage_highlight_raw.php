                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_sponsor">
					...
					?>	
							...
							<td style="vertical-align: middle;">
                                ...
                                <td class=""><?php echo $highlight_arr[$i]['type']; ?></td>
                                <td class=""><?php echo $highlight_arr[$i]['compatibility']; ?></td>
                               
                                <td class="">
									<a  href="<?php echo base_url();?>video-highlights/manage_highlight/update_highlight_raw/<?php echo $highlight_arr[$i]['id']; ?>" class="btn <?php
								...
								<a href="<?php echo base_url();?>video-highlights/manage_highlight/delete_highlight_raw/<?php echo $highlight_arr[$i]['id']?>" type="button" class="btn btn-danger btn-gradient" style="" onClick="return confirm('Are you sure you want to delete?')"> <span class="glyphicons glyphicons-remove"></span> </a>
								</td>
								<?php } ?>
                            </tr>
                    <?php			
