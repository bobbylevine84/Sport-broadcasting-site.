					...
					<div class="col-md-12">
						<div class="panel panel-visible">
							...
							<?php if($b['status']=='approved') {}else{
								?><a href="<?php echo base_url();?>highlight/manage_highlight/update_highlight_status/<?php echo $b['id']?>" type="button" class="btn btn-success btn-gradient btn pull-right" style="" > Approve Highlight </a>
								<?php
							} ?>
							
							
							<a href="<?php echo base_url();?>highlight/manage_highlight/delete_highlight/<?php echo $b['id']?>" type="button" class="btn btn-danger btn-gradient btn pull-right" style="" onClick="return confirm('Are you sure you want to delete?')"> Delete Highlight </a>
							<?php } ?>
							<div class="wrap1">
