...
<script>
function site_man_mode(a)
		{//alert(a);

				$.ajax({
				url: "<?php echo base_url(); ?>templates/email/change_mode/"+a+"", // Url to delete image function
					...
					<div class="col-md-12">
						<div class="panel panel-visible">
							...
							if(!empty($maintenance_mode)){
                                    ...
                                    ON <input type="radio" name="site_man_mode" onClick="return site_man_mode(1);" <?php if($site_mode_status1){ ?> checked<?php }?>/> | 
                                    OFF <input type="radio" name="site_man_mode" onClick="return site_man_mode(0);"<?php if(!$site_mode_status1){ ?> checked<?php }?>/>
                                    <br/>
                                    <br/>
                                    <br/>
                                    <div class="form-group">
                                    	<label>Content</label>
                                    	<textarea class="ckeditor form-control editor1" rows="14" name="mantances_content"></textarea>
                                    </div>
                                    <?php
								}
							else if($template_list_count > 0)
							{?>
