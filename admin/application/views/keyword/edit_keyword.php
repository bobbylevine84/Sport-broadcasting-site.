        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
				<div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Edit keyword</div>
            ...
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="" action="<?php echo base_url(); ?>keyword/manage_keyword/edit_keyword_process" method="POST"  enctype="multipart/form-data">
						<?php
						...
						<div class="form-group">
							...
							<input type="text"  value="<?php echo $keyword[0]['keyword'];?>" placeholder="Enter Keyword" class="form-control" name="keyword" id="keyword" class="keyword" required>
						</div>
						<input type="hidden" name="id" value="<?php echo $keyword[0]['id'];?>">
						<div class="form-group" align="right" style="">
							<input class="submit btn btn-primary" type="submit" name="add_Keyword" id="update_Keyword" value="Update Keyword" />
						</div>
