...
<form action="<?php echo base_url('settings/manage_setting/update_grp_sr');?>" method="post">
  <!-- Tab panes -->
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="tab1">
		...
		<?php foreach($grp_sr_settings as $data){
...
<input id="hidden_<?php echo $data['inst_name'];?>" name="hidden_<?php echo $data['inst_name'];?>" type="hidden" value="<?php echo $data['id']; ?>"/>
	<input id="ex_per_w_<?php echo $data['inst_name'];?>" name="ex_per_w_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['ex_per'];?>" class="form-control" step="0.1" type="number" placeholder="30" />
	</div>
	</div>
    </div>
    <div class=" col-md-4">
...
$('document').ready(function(){
    ...
    $("#select_group").change(function(){
		var data = $(this).val();
		//alert(data);
		$.post('<?php echo base_url() ?>settings/manage_setting/group_SR_settings', {'data': data}, function(data){
