...
<form action="<?php echo base_url('settings/manage_setting/update_fee');?>" method="post">
  <!-- Tab panes -->
...
<input name="hidden_<?php echo $data['inst_name'];?>" type="hidden" value="<?php echo $data['id']; ?>"/>
	<input name="in_per_w_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['indi_per'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    <div class=" col-md-4">
	...
	<div class="input-group-addon">%</div>
    <input name="hidden_<?php echo $data['inst_name'];?>" type="hidden" value="<?php echo $data['id']; ?>"/>
	<input name="bu_per_w_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['busi_per'];?>" class="form-control" type="number"  step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    <div class=" col-md-4">
	...
	<div class="input-group">
	<div class="input-group-addon">F</div>
	<input name="bu_fix_w_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['busi_fix'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    </div>
	...
	<div class="input-group">
	<div class="input-group-addon">%</div>
 <input name="hidden_d_<?php echo $data['inst_name'];?>" type="hidden" value="<?php echo $data['id']; ?>"/>
	<input name="in_per_d_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['indi_per'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    <div class=" col-md-4">
	...
	<div class="input-group">
	<div class="input-group-addon">F</div>
	<input name="in_fix_d_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['indi_fix'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    </div>
	...
	<div class="input-group-addon">%</div>
     <input name="hidden_d_<?php echo $data['inst_name'];?>" type="hidden" value="<?php echo $data['id']; ?>"/>
	<input name="bu_per_d_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['busi_per'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    <div class=" col-md-4">
	...
	<div class="input-group">
	<div class="input-group-addon">F</div>
	<input name="bu_fix_d_<?php echo $data['inst_name'];?>" value="<?PHP echo $data['busi_fix'];?>" class="form-control" type="number" step="0.1" placeholder="30" />
	</div>
	</div>
    </div>
    </div>
