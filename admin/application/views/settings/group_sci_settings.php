...
<form action="<?php echo base_url('settings/manage_setting/update_grp_sci');?>" method="post">
  <!-- Tab panes -->
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="tab1">
		...
		<?php foreach($grp_sci_settings as $data){
...
$('document').ready(function(){
    ...
    $("#select_group").change(function(){
		var data = $(this).val();
		//alert(data);
		$.post('<?php echo base_url() ?>settings/manage_setting/group_sci', {'data': data}, function(data){
