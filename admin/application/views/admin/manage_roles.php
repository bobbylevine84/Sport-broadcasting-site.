                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_admin_roles">
					...
					?>
                              <tr>
                                ...
                                <td class="hidden-xs hidden-sm"><?php echo ($admin_roles_arr[$i]['status'] == 1) ? '<span class="label btn-success">Active</span>' : '<span class="label btn-danger">InActive</span>' ?></td>
                                <td class="hidden-xs hidden-sm"><?php echo date('d, M Y', strtotime($admin_roles_arr[$i]['created_date'])) ?></td>
