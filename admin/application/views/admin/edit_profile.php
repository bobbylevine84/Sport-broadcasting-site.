                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <input id="first_name" name="first_name" type="text" class="form-control" placeholder="Type your First Name" value="<?php echo stripslashes($admin_profile_data['first_name']) ?>" required/>
                      </div>
                      <div class="form-group">
                        <label for="last_name">Last Name*</label>
                        <input id="last_name" name="last_name" type="text" class="form-control" placeholder="Type your Last Name" value="<?php echo stripslashes($admin_profile_data['last_name']) ?>" required/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input id="username" name="username" type="text" class="form-control" placeholder="Type Your Username" pattern="^[A-Za-z]+" value="<?php echo stripslashes($admin_profile_data['username']) ?>" required />
                    ...
                    <div class="row form-group">
                        ...
                        ?>
                        <div class="col-md-5">
                            <img style="height:173px;width:180px;"src="<?php echo USER_FOLDER.'/'.$admin_profile_data['id'].'/'.stripslashes($admin_profile_data['profile_image'])?>">
                        </div>
                        <?php }//end if?>
                    </div>                                          
                  </div>
