      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <form class="cmxform" id="" action="<?php echo base_url(); ?>ads/manage_ads/update_live_ad" method="POST"  enctype="multipart/form-data">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="panel-body alerts-panel">
						...
						--><?php
						$ads = $this->db->get('kt_ads_live')->result_array();
						?>
						
						<div class="form-group">
							<label>Link </label>
							<input type="text" value="<?php echo $ads[0]['url']; ?>" class="form-control" id="url" value="" name="url" required>
						</div>
						<!--
						<div class="checking">
						...
						<div class="form-group" align="" style="">
							<input class="submit btn btn-primary" type="submit" name="add_ads" id="add_ads" value="Update Ad" />
						</div>
					</div>
				</div>
			</form>
