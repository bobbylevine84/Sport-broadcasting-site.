      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            ...
            <form class="cmxform" id="" action="<?php echo base_url(); ?>ads/manage_ads/add_new_stream_ads_process" method="POST"  enctype="multipart/form-data">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="panel-body alerts-panel">
						...
						<select class="form-control" id="c_id" class="c_id" name="id" >
							...
							<option value="<?php echo ucwords(strtolower($c['competition_id']));?>"><?php echo $c['competition_name'];?></option>
							<?php } ?>
						</select>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Bitrate </label>
							<input type="text" class="form-control" id="bit" value="" name="bitrate" required>
						</div>
						<div class="form-group">
							<label>Language </label>
							<input type="text" class="form-control" id="lang" value="" name="lang" required>
						</div>
						
						<div class="checking">
							<label>Sponsered</label>
							<input type="checkbox" id="check" value="" name="sponser">
						</div>
