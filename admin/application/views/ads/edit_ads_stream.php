        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
			  ...
			  <a href="<?php echo base_url('ads/manage_ads/stream_ads'); ?>">
            ...
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="add_new_slider_image_frm" method="POST" action="<?php echo SURL?>ads/manage_ads/edit_ads_stream_process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
					<div id="cms_main_contents" class="tab-pane active">
						...
						<div class="form-group">
							<label>Bitrate </label>
							<input type="text" class="form-control" id="bit" value="<?php echo $ads_arr[0]['bitrate'];?>" name="bitrate" required>
						</div>
						<div class="form-group">
							<label>Language </label>
							<input type="text" class="form-control" id="lang" value="<?php echo $ads_arr[0]['lang'];?>" name="lang" required>
						</div>
						
						<div class="checking">
							<label>Sponsered</label>
							<input type="checkbox" id="check" name="sponser" <?php if($ads_arr[0]['sponsered'] == '1') { echo "checked"; } ?> >
						</div>
