            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                <div class="panel-heading">
				 ...
				 <a href="<?php echo base_url('ads/manage_ads/add_new_ads/'); ?>">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_sponsor">
                    ...
                    <?php 
                            ...
                            <tr>	<!-- Count rows -->
								...
								<td class=""><img style="height:50px;width:50px;"src="<?php echo base_url();?>uploads/game_images/<?php echo $ads_arr[$i]['image'];?>"
								</td>
							   ...
							   <td><?php foreach($competition as $c ){ echo $c['competition_name']; } ?></td>
								...
								<td>
								<a href="<?php echo base_url();?>ads/manage_ads/update_ads/<?php echo $ads_arr[$i]['id']?>" type="button" class="btn btn-info btn-gradient" style=""> <span class="glyphicons glyphicons-edit"></span> </a>
								<a href="<?php echo base_url();?>ads/manage_ads/delete_ads/<?php echo $ads_arr[$i]['id']?>" type="button" class="btn btn-danger btn-gradient" style="" onClick="return confirm('Are you sure you want to delete?')"> <span class="glyphicons glyphicons-remove"></span> </a>
								</td>
                            </tr>
                    <?php			
							}
