                                                        ...
                                                        <tbody>
                                                            <?php foreach ($banned_user as $c) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a type="button" class="btn btn-info btn-gradient" href="<?php echo base_url(); ?>users/manage_user/edit_user/<?php echo $c['front_user_id']; ?>/banned"><span class="glyphicons glyphicons-edit"></span></a>
                                                                            <a type="button" class="btn btn-danger btn-gradient" onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url(); ?>users/manage_user/delete_user/<?php echo $c['front_user_id']; ?>/banned"><span class="glyphicons glyphicons-remove"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add_amount" method="post" action="<?php echo base_url(); ?>users/manage_user/add_amount">
                            ...
                            <input type="hidden" id="balance_id" name="type" value="banned" class="form-control" />
                        </form>
                    </div>
...
<script type="application/javascript">
    ...
    status = "<span class='label btn-danger'>Banned</span>";
    }
    if(val.user_type == 1) {
    ...
    var button = '<div class="btn-group"><a type="button" class="btn btn-info btn-gradient" href=""><span class="glyphicons glyphicons-edit"></span></a><a type="button" onclick="return confirm("Are you sure you want to delete?")" class="btn btn-danger btn-gradient" href="<?php echo base_url(); ?>users/manage_user/delete_user/'+val.user_id+'/banned"><span class="glyphicons glyphicons-remove"></span></a></div>';
