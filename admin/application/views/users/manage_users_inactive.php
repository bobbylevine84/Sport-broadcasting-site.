...
<html>
    ...
    <body>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-visible">
                                        ...
                                        <form class="cmxform" id="change_multiple_publishstatus" method="POST" action="<?php echo SURL ?>users/manage_user/approve_multiple_records">
                                            <input type="hidden" name="page" value="inactive_page"/>
                                            ...
                                            <div class="panel-body padding-bottom-none">
                                                ...
                                                if (count($inactive_user) > 0) {
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover searchable " id="manage_all_menus">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($inactive_user as $c) { ?>
                                                                <tr>
        ...
        <?php echo $c['front_user_flag']; ?>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a type="button" class="btn btn-info btn-gradient" href="<?php echo base_url(); ?>users/manage_user/edit_user/<?php echo $c['front_user_id']; ?>/inactive"><span class="glyphicons glyphicons-edit"></span></a>
                                                                            <a type="button" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-gradient" href="<?php echo base_url(); ?>users/manage_user/delete_user/<?php echo $c['front_user_id']; ?>/inactive"><span class="glyphicons glyphicons-remove"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add_amount" method="post" action="<?php echo base_url(); ?>users/manage_user/add_amount">
                            ...
                            <input type="hidden" id="balance_id" name="type" value="inactive" class="form-control" />
                        </form>
                    </div>
                ...
                otable.fnClearTable();
                        $.each( obj, function( key, val ) {
                                ...
                                if(val.user_status == 0) {
                                        status = "<span class='label btn-warning'>InActive</span>";
                                }
                                if(val.user_type == 1) {
