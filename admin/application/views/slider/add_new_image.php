      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
           ...
           <a href="<?php echo base_url(); ?>slider/manage-slider"><span class="glyphicon glyphicon-hand-left" aria-hidden="true" style="float:right;"></span></a>
            </div>
                ...
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                      ...
                      <div class="form-group">
                        <label for="page_title">Upload Slider Image *</label>
						 <br/>
                            ...
                            <span class="help-block margin-top-sm"><i class="fa fa-bell"></i> 
                                Max Upload Size: 6MB; Recommended Dimension: 1600 * 450                            </span>
                        <input type="file" id="slider_image" name="slider_image">
                      </div>
                     <!-- <div class="form-group">
                        <label for="page_short_desc">URL Link</label>
                        <textarea class="form-control" id="slider_caption" name="slider_caption" rows="1"><?php// echo $session_post_data['slider_caption'] ?></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control editor1" rows="14"  id="slider_caption" name="slider_content" ><?php //echo $session_post_data['slider_content'] ?></textarea>
                      </div>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="add_image_sbt" id="add_image_sbt" value="Add New Slider" />
                    </div>
                </div>
