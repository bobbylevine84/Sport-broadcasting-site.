            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                <div class="panel-heading">
                  <div class="panel-title"> <span class="glyphicon glyphicon-picture"></span>
					...
					?>
                            ...
                            <?php //echo img.stripslashes($slider_images_arr[$i]['slider_image']); exit;?>
                                ...
                                <td class=""><span class="xedit">
									<img  src="<?php echo FRONT."/assets/images/".stripslashes($slider_images_arr[$i]['slider_image']);//echo IMG.stripslashes($slider_images_arr[$i]['slider_image']) ?>"></span>
                                </td>
                               ...
                               <td class="hidden-xs hidden-sm"><?php //echo (stripslashes($slider_images_arr[$i]['slider_content']) == '') ? '-' : stripslashes($slider_images_arr[$i]['slider_content']); ?></td>
								...
								<td><?php //echo (stripslashes($slider_images_arr[$i]['slider_button_text']) == '') ? '-' : stripslashes($slider_images_arr[$i]['slider_button_text']); ?></td>-->
								<!--
