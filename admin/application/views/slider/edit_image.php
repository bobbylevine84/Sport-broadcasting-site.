                ...
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      <div class="form-group">
                        <label for="page_title">Upload Slider Image *</label>
                        	<br/>
						 	<a class=" image-popup-no-margins" href="<?php echo FRONT."/uploads/events/".stripslashes($slider_image_data['image_url'])?>">
                            	<img src="<?php echo FRONT."/uploads/events/".stripslashes($slider_image_data['image_url'])?>" width="200" height="170">
                            </a>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="slider_caption" name="slider_caption" rows="1"><?php //echo stripslashes($slider_image_data['slider_caption']) ?></textarea>
                      </div>
						
                      <div class="form-group">
                        <label for="page_short_desc">Button Text</label>
                        <input type="text" name="button_text" value="<?php //echo stripslashes($slider_image_data['slider_button_text']) ?>" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="page_short_desc">Content</label>
                        <textarea class="ckeditor form-control editor1" rows="14"  id="slider_caption" name="slider_content" >
                        <?php //echo stripslashes($slider_image_data['slider_content']) ?></textarea>
                      </div>
                      -->
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="upd_image_sbt" id="upd_image_sbt" value="Update Slider" />
