					...
					<div class="panel-body alerts-panel">
						...
						<div class="wrapper" id="input_embed">
							<div class="form-group">
								...
								<textarea rows="5" cols="95" style="border-radius:3%;"name="description" placeholder="Enter Description....." required></textarea>
							</div>
						</div>
						<div class="wrapper" id="input_embed">
							<div class="form-group">
								<label for="">Main Channel Feed *</label>
								<textarea rows="5" cols="95" style="border-radius:3%;" name="main_frame" placeholder="Enter Feed....." required></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="wrapper" id="">
							<div class="form-group">
								...
								<textarea rows="5" cols="95" style="border-radius:3%;" name="iframe[]" placeholder="Embed Code....." required></textarea>
							</div>
							<div class="form-group">
								<label for="">Channel Feed (2)</label>
								<textarea rows="5" cols="95" style="border-radius:3%;" name="iframe[]" placeholder="Embed Code....." ></textarea>
...
<script>
 ...
 $("#btn2").click(function(){
		...
		number++;
		//console.log(number);
        $(".add").append("<label for=''>Channel Feed ("+number+")</label><textarea rows='5' cols='95' style='border-radius:3%;' name='iframe[]' id='last1' placeholder='Iframe.....' ></textarea>");
