...
class Color_scheme extends CI_Controller {
	...
	public function index(){
		...
		$this->breadcrumbcomponent->add('Manage Color Scheme', base_url().'cms/manage-color_scheme');
		...
		$this->load->view('cms/color_scheme',$data);
		
	}//end index()	
	public function color_scheme_process(){
		...
		$query = $this->db->update('kt_color',$update_data);
			if($query){
				...
				$this->session->set_flashdata('ok_message', '- Successfull.');
				redirect(base_url().'cms/color_scheme/');
			}
		}
	}
